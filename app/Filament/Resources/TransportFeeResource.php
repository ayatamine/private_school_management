...
class TransportFeeResource extends Resource
{
    ...
    protected static ?string $navigationIcon = 'icon-transport_fees';
    ...
    {
        return trans_choice('main.transport_fee',1);
    }
    ...
    {
        return [
            'index' => Pages\ListTransportFees::route('/'),
            'create' => Pages\CreateTransportFee::route('/create'),
            'edit' => Pages\EditTransportFee::route('/{record}/edit'),
        ];
    }
}
