...
<html lang="ar" dir="rtl">
    ...
    <body>
        ...
        <hr> --}}
        {{-- invoice info --}}
        <h5 class="text-uppercase cool-gray" style="text-align: center;margin:auto;font-family: 'cairo';">
            <strong style="direction: rtl;font-size:18px;font-weight:bold">{{ trans('main.student_info')}}</strong>
        </h5>
        <table class=" mt-5"  style="width: 100%">
            <tbody>
                <tr>
                  ...
                  @foreach ($fee->payment_partition as $i=> $partition)
                    ...
                    <tr>
                        ...
                        <td >
                            ...
                            {{number_format($tuition_value_after_discount[$i], 2, '.', ',')}}
                        </td>
                         @else 
