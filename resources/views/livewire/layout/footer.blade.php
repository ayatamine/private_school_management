    ...
    <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
      <div class="w-full mb-10">
        ...
        <p class="mb-8 max-w-[270px] text-base text-gray-7">
          الان خسيب كشنمسيبتنسيب سيمبننمس بسينمبسي ش كنميسبم كشبنمسيب
        </p>
        ...
        <div class="flex flex-col gap-8">
          ...
          >
            <div class="overflow-hidden rounded">
              <img
                src="{{asset('landing/assets/images/blog/blog-footer-01.jpg')}}"
                alt="blog"
              />
            </div>
            <span
          ...
          >
            <div class="overflow-hidden rounded">
              <img
                src="{{asset('landing/assets/images/blog/blog-footer-02.jpg')}}"
                alt="blog"
              />
            </div>
            <span
